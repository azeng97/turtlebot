...
if("TRUE" STREQUAL "TRUE")
  set(crosbot_ogmbicp_SOURCE_PREFIX /home/azeng/turtle_ws/src/crosbot/crosbot_ogmbicp)
  set(crosbot_ogmbicp_DEVEL_PREFIX /home/azeng/turtle_ws/devel)
  ...
  set(crosbot_ogmbicp_INSTALL_PREFIX /home/azeng/turtle_ws/install)
...
if(NOT "/home/azeng/turtle_ws/devel/include;/home/azeng/turtle_ws/src/crosbot/crosbot_ogmbicp/include " STREQUAL " ")
  set(crosbot_ogmbicp_INCLUDE_DIRS "")
  set(_include_dirs "/home/azeng/turtle_ws/devel/include;/home/azeng/turtle_ws/src/crosbot/crosbot_ogmbicp/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'mmcgill <mmcgill@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'crosbot_ogmbicp' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'crosbot_ogmbicp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/azeng/turtle_ws/src/crosbot/crosbot_ogmbicp/${idir}'.  ${_report}")
    endif()
...
set(crosbot_ogmbicp_EXPORTED_TARGETS "crosbot_ogmbicp_generate_messages_cpp;crosbot_ogmbicp_generate_messages_eus;crosbot_ogmbicp_generate_messages_lisp;crosbot_ogmbicp_generate_messages_nodejs;crosbot_ogmbicp_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${crosbot_ogmbicp_dep}_FOUND)
      find_package(${crosbot_ogmbicp_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${crosbot_ogmbicp_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
