...
class ListSnapsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ListSnapsRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ListSnapsRequest
    let len;
    let data = new ListSnapsRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ListSnapsRequest(null);
    return resolved;
    }
};

class ListSnapsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.snaps = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ListSnapsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ListSnapsResponse
    let len;
    let data = new ListSnapsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ListSnapsResponse(null);
...
module.exports = {
  Request: ListSnapsRequest,
  Response: ListSnapsResponse,
  md5sum() { return 'a9950552cda46ef9fb7f384a56cf8cd8'; },
  datatype() { return 'crosbot_map/ListSnaps'; }
};
