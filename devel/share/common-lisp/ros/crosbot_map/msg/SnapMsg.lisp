...
(cl:defclass <SnapMsg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (clouds
    :reader clouds
    :initarg :clouds
    :type (cl:vector crosbot_msgs-msg:PointCloudMsg)
   :initform (cl:make-array 0 :element-type 'crosbot_msgs-msg:PointCloudMsg :initial-element (cl:make-instance 'crosbot_msgs-msg:PointCloudMsg))))
)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SnapMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'clouds)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'crosbot_msgs-msg:PointCloudMsg))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
