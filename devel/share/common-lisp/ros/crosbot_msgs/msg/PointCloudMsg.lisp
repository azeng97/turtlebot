...
(cl:defclass <PointCloudMsg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (colours
    :reader colours
    :initarg :colours
    :type (cl:vector crosbot_msgs-msg:ColourMsg)
   :initform (cl:make-array 0 :element-type 'crosbot_msgs-msg:ColourMsg :initial-element (cl:make-instance 'crosbot_msgs-msg:ColourMsg))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PointCloudMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointCloudMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crosbot_msgs-msg:<PointCloudMsg> is deprecated: use crosbot_msgs-msg:PointCloudMsg instead.")))
...
(cl:defmethod points-val ((m <PointCloudMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crosbot_msgs-msg:points-val is deprecated.  Use crosbot_msgs-msg:points instead.")
  (points m))

(cl:ensure-generic-function 'colours-val :lambda-list '(m))
(cl:defmethod colours-val ((m <PointCloudMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crosbot_msgs-msg:colours-val is deprecated.  Use crosbot_msgs-msg:colours instead.")
  (colours m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PointCloudMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'colours)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'crosbot_msgs-msg:ColourMsg))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
