...
(cl:defclass <ColouredPointMsg> (roslisp-msg-protocol:ros-message)
  ((p
   ...
   (c
    :reader c
    :initarg :c
    :type crosbot_msgs-msg:ColourMsg
    :initform (cl:make-instance 'crosbot_msgs-msg:ColourMsg)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ColouredPointMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ColouredPointMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crosbot_msgs-msg:<ColouredPointMsg> is deprecated: use crosbot_msgs-msg:ColouredPointMsg instead.")))

(cl:ensure-generic-function 'p-val :lambda-list '(m))
(cl:defmethod p-val ((m <ColouredPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crosbot_msgs-msg:p-val is deprecated.  Use crosbot_msgs-msg:p instead.")
  (p m))

(cl:ensure-generic-function 'c-val :lambda-list '(m))
(cl:defmethod c-val ((m <ColouredPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crosbot_msgs-msg:c-val is deprecated.  Use crosbot_msgs-msg:c instead.")
  (c m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ColouredPointMsg>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point p~%ColourMsg c~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: crosbot_msgs/ColourMsg~%uint8 r~%uint8 g~%uint8 b~%uint8 a~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ColouredPointMsg)))
  "Returns full string definition for message of type 'ColouredPointMsg"
  (cl:format cl:nil "geometry_msgs/Point p~%ColourMsg c~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: crosbot_msgs/ColourMsg~%uint8 r~%uint8 g~%uint8 b~%uint8 a~%~%"))
