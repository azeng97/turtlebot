...
(cl:defmethod cl:initialize-instance :after ((m <ColourMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ColourMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crosbot_msgs-msg:<ColourMsg> is deprecated: use crosbot_msgs-msg:ColourMsg instead.")))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <ColourMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crosbot_msgs-msg:r-val is deprecated.  Use crosbot_msgs-msg:r instead.")
  (r m))

(cl:ensure-generic-function 'g-val :lambda-list '(m))
(cl:defmethod g-val ((m <ColourMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crosbot_msgs-msg:g-val is deprecated.  Use crosbot_msgs-msg:g instead.")
  (g m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <ColourMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crosbot_msgs-msg:b-val is deprecated.  Use crosbot_msgs-msg:b instead.")
  (b m))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <ColourMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crosbot_msgs-msg:a-val is deprecated.  Use crosbot_msgs-msg:a instead.")
  (a m))
