...
"""autogenerated by genpy from crosbot_msgs/ControlStatus.msg. Do not edit."""
import sys
...
class ControlStatus(genpy.Message):
  _md5sum = "4b1b69ac1f23ea296f1f5dda15caa88f"
  _type = "crosbot_msgs/ControlStatus"
...
"""
  ...
  LEVEL_INFO = r'"level_info"'
  LEVEL_WARNING = r'"level_warning"'

  __slots__ = ['header','stats_namespace','level','status','args']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,stats_namespace,level,status,args
    ...
    if args or kwds:
      ...
      if self.stats_namespace is None:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.stats_namespace = str[start:end].decode('utf-8')
      else:
        self.stats_namespace = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
